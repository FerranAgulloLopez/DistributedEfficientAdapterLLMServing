...
def main(args: argparse.Namespace, placement_type: str):
    ...
    servers: List[str] = [f'server_{server_id}' for server_id in range(args.num_servers)]
    print('Defined servers', servers)

    # retrieve placement class
    ...
    # precache placement for algorithms that are helped by it
    _ = placement_algorithm.define_placement(
