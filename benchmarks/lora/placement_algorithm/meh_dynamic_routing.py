import time
import random
from interface_dynamic_routing import PlacementAlgorithmInterfaceDynamicRouting
from factory import get_subclass_dynamic_routing
import numpy as np
...
rates_to_use = [0.075, 0.0375, 0.01875, 0.009375, 0.0046875]
...
placement_algorithm: PlacementAlgorithmInterfaceDynamicRouting = get_subclass_dynamic_routing(METHOD)()
