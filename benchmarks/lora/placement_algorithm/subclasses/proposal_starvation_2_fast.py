...
import numpy as np
from benchmarks.lora.predict_digital_twin import predict_digital_twin_fast as predict_digital_twin

"""
Corresponds to paper ProposedFast algorithm
"""

ML_MODEL_PATH_THROUGHPUT: Dict[str, str] = {
    'llama-3.1-8b-instruct': '/gpfs/scratch/bsc98/bsc098069/experiment_data/llm_benchmarking/models/trained_ml/llama-3.1-8b-instruct/explainability/reg/rf_simpler/',
    'qwen-2.5-7b-instruct': '/gpfs/scratch/bsc98/bsc098069/experiment_data/llm_benchmarking/models/trained_ml/qwen-2.5-7b-instruct/explainability/reg/rf_simpler_2/',
}
ML_MODEL_PATH_STARVATION: Dict[str, str] = {
    'llama-3.1-8b-instruct': '/gpfs/scratch/bsc98/bsc098069/experiment_data/llm_benchmarking/models/trained_ml/llama-3.1-8b-instruct/explainability/class/rf_simpler/',
    'qwen-2.5-7b-instruct': '/gpfs/scratch/bsc98/bsc098069/experiment_data/llm_benchmarking/models/trained_ml/qwen-2.5-7b-instruct/explainability/class/rf_simpler/',
}
...
class PlacementAlgorithmProposalStarvation2Fast(PlacementAlgorithmInterface):
