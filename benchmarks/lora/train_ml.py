...
def train_model(
    ...
    for y_feature_index, y_feature_label in enumerate(y_features):
        ...
        print(f'Hypeparameter search time: {time.perf_counter() - init_time}')
        ...
        # extract rules if set
        if extract_rule_number:
            all_rules = []
            for tree in estimator.best_estimator_.estimators_:
                tree = tree.tree_
...
def main(
    ...
    train_model(
        ...
        extract_rule_number=extract_rule_number,
...
if __name__ == '__main__':
    ...
    parser.add_argument('--extract-rule-number', default=False, action='store_true', help='Extract number of rules for RF')
    ...
    main(
        ...
        extract_rule_number=args.extract_rule_number,
    )
