...
if __name__ == '__main__':
    ...
    parser.add_argument('--running-script', type=str, default='benchmarks/lora/train_ml.py', help='Script to run', required=False)
    ...
    main(
        ...
        running_script=args.running_script,
    )
