...
from benchmarks.lora.placement_algorithm.interface_dynamic_routing import \
    PlacementAlgorithmInterfaceDynamicRouting
from benchmarks.lora.placement_algorithm.factory import \
    check_subclass_dynamic_routing as check_placement_algorithm_subclass, \
    get_subclass_dynamic_routing as get_placement_algorithm_subclass
...
async def send_adapter_requests(
    ...
    async for (prompt, prompt_len, output_len, next_interval) in get_request(adapter_requests, adapter_rate, finish_time):
        ...
        api_url: str = random.choice(api_urls)
...
def main(args: argparse.Namespace):
    ...
    try:
        ...
        init_time: float = time.perf_counter()
        placement_algorithm: PlacementAlgorithmInterfaceDynamicRouting = get_placement_algorithm_subclass(args.placement_algorithm)()
        try:
