...
from benchmarks.lora.placement_algorithm.factory import \
    check_subclass_dynamic_routing_with_probabilities as check_placement_algorithm_subclass, \
    get_subclass_dynamic_routing_with_probabilities as get_placement_algorithm_subclass
...
def main(args: argparse.Namespace):
    ...
    try:
        ...
        init_time: float = time.perf_counter()
        placement_algorithm: PlacementAlgorithmInterfaceDynamicRoutingWithProbabilities = get_placement_algorithm_subclass(args.placement_algorithm)()
        try:
